    ...
    return (
      <div className="container">
        ...
        <Input
          name="Interest in %"
          value={interest}
          changed={this.props.setInterest}
          step={1}
          min={10}
          max={25}
        />
        ...
        <br />
        <Button
          calculate={() => this.props.onCalculate(amount, interest, years)}
        >
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    onCalculate: (amount, interest, years) =>
      dispatch(calculateResults(amount, interest, years))
  };
};
